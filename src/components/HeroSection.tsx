          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="glass-card glow-border rounded-lg p-5 mb-8 inline-block text-left">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                <div>
                  <span className="text-muted-foreground font-mono">degree:</span>{" "}
                  <span className="text-foreground">B.E. CSE</span>
                </div>
                <div>
                  <span className="text-muted-foreground font-mono">cgpa:</span>{" "}
                  <span className="text-primary font-semibold">8.66</span>
                </div>
                <div className="sm:col-span-2">
                  <span className="text-muted-foreground font-mono">college:</span>{" "}
                  <span className="text-foreground">GCE, Salem</span>
                </div>
                <div>
                  <span className="text-muted-foreground font-mono">duration:</span>{" "}
                  <span className="text-foreground">Nov 2022 - Apr 2026</span>
                </div>
              </div>
            </div>
